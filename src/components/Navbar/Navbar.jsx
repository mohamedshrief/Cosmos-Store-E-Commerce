        ...
        <div className="flex justify-center items-center gap-0 md:gap-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          {!token ? (
            <Link
              to={"/login"}
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-xl text-lg font-bold  px-2 md:px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Login
            </Link>
          ) : (
            <button
              ...
              type="button"
              className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-2 md:px-5 py-2.5 text-center md:me-2 mb-2"
            >
              Logout
            </button>
          )}
          ...
          <ul className="flex flex-col p-4 w-full md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 text-white">
            <li>
              <NavLink
                to="/home"
                className={({ isActive }) =>
                  `py-2 px-3 hover:bg-gray-100 text-neutral-900 font-bold  md:hover:bg-transparent md:p-0 dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700 ${
