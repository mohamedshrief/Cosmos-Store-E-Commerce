        ...
        <div className="mx-auto w-full max-w-screen-xl px-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-white dark:text-white uppercase ">
                  Resources
                </h2>
                <ul className="text-white dark:text-white font-medium">
                  <li className="mb-4">
                    <span className="hover:underline">
                      Eng: Mohamed Abd Elsalam
                    </span>
                  </li>
                  <li className="mb-4">
                    <span className="hover:underline">Eng: Mahmoud Hesham</span>
                  </li>
                </ul>
              </div>
              <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-white dark:text-white sm:text-center ">
              © 2025{" "}
              <a
                href="https://mohmedshrief97@gmail.com/"
                className="hover:underline"
              >
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#" className="text-white hover:text-cyan-200 ms-5">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="https://github.com/mohamedshrief/"
                className="text-white hover:text-cyan-200 ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
